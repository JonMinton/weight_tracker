...
```
So now there is evidence of a weekend effect, with weekends associated with around +0.4kg compared with weekday trends. This suggests the weekend effect should be included in the model. 
